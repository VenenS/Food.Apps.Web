...
namespace System
{
    public static class StringHtmlExtensions
    {
        ...
        /// <returns></returns>
        public static string TruncateHtmlByDelimiter(this string html, string delimiter,
        ...
        /// 
        /// </summary>
        /// <param name="inputNumber">Количество</param>
        /// <param name="form1">Один элемент</param>
        /// <param name="form2">От двух до четырех</param>
        /// <param name="form3">От пяти до двадцати</param>
        /// <returns></returns>
        public static string FormWordFromNumber(this int inputNumber, string form1, string form2, string form3)
        {
            var count = Math.Abs(inputNumber);
            count %= 100;
            
            if (count >= 5 && count <= 20)
                return inputNumber + " " + form3;
            
            count %= 10;
            if (count == 1)
                return inputNumber + " " + form1;
            
            if (count >= 2 && count <= 4)
                return inputNumber + " " + form2;
        ...
        /// <param name="form3">От пяти до двадцати</param>
        /// <returns></returns>
        public static string FormWordFromNumber(this long inputNumber, string form1, string form2, string form3)
        {
            var count = Math.Abs(inputNumber);
            count %= 100;
        ...
        public static string DateToWord(this DateTime date)
        {
            ...
            else if (date.Date.AddDays(1) == dateToday)
            {
